...
const badWords = [
    ...
    "cok", "goblok", "idiot",
    "jancok", "jembut", "keparat", "kont*l", "l*nte",
    "maling", "ngentot", "p*nt*k", "puki",
    "p*k*mak", "setan", "sialan", "sund*l", "tai",
    "telaso", "tengik", "titit", "tolol", "torpedo",
